...
import com.dong.enums.SearchModelEnum;
import com.dong.enums.YesOrNoEnum;
...
import com.dong.strategy.context.SearchStrategyContext;
import com.dong.util.*;
import com.dong.dto.ArticleDTO;
...
import static com.dong.common.Constants.*;
import static com.dong.common.RedisConstants.*;
import static com.dong.common.ResultCode.*;
import static com.dong.enums.PublishEnum.PUBLISH;
...
public class ArticleServiceImpl extends ServiceImpl<ArticleMapper, BlogArticle> implements ArticleService {
    ...
    public ResponseResult articleSeo(List<Long> ids) {
        ...
        ids.forEach(item -> {
            String url = "http://www.com/article/" + item;
